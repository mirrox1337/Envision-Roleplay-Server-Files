...
AddEventHandler('esx_oranges:sellOrange', function(itemName, amount)
	...
	if not price then
		print(('esx_drugs: %s Det där skiten köper inte jag!'):format(xPlayer.identifier)) --Edit this. Thats show you a Notification in your console when someone try to sell  a item that he doenst have
		return
	end
