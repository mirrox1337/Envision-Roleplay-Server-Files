Locales['en'] = {
  ...
  ['already_own'] = 'Du har redan köpt : %s',
  ['not_enough_money'] = 'Företaget har inte råd med denna del!',
  ['purchased'] = 'Köpet gick igenom!',
  ['press_custom'] = 'Tryck ~INPUT_PICKUP~ för att styla fordon.',
  ['level'] = 'Nivå %s',
  ['neon'] = 'Xeon',
...
-- Cosmetics
  ['cosmetics'] = 'Styling',
  -- Body Parts
  ['bodyparts'] = 'Chassi delar',
  ['leftfender'] = 'Väster fender',
  ['rightfender'] = 'Höger fender',
  ['spoilers'] = 'Vinge',
  ['sideskirt'] = 'Sido kjolar',
  ['cage'] = 'cage',
  ['hood'] = 'Motorhuv',
  ['grille'] = 'Grill',
  ['rearbumper'] = 'Bakre kofångare',
  ['frontbumper'] = 'Främre kofångare',
  ['exhaust'] = 'Avgasrör',
  ['roof'] = 'Tak',
  -- Paint
  ['respray'] = 'Lack',
  ...
  ['pearlescent'] = 'pärlemorskimrande',
  -- Misc
  ['headlights'] = 'Strålkastare',
  ['licenseplates'] = 'Registreringsskylt',
  ['windowtint'] = 'Fönster toning',
  ['horns'] = 'Tuta',
  -- Neon
  ['neons'] = 'neon',
  -- Wheels
