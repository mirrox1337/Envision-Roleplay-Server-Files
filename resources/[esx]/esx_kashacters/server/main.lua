...
local IdentifierTables = {
    ...
    {table = "favoriteanimation", column = "identifier"},
    ...
    {table = "jsfour_medicalrecord", column = "identifier"},--Här
    {table = "jsfour_medicaluserinfo", column = "identifier"},--Här
    {table = "user_messages", column = "identifier"},
    {table = "society_moneywash", column = "identifier"},
    {table = "characters_skills", column = "cid"},
    {table = "user_licenses", column = "owner"},
    {table = "addon_account_data", column = "owner"},
    {table = "addon_inventory_items", column = "owner"},
    {table = "user_calls", column = "identifier"},
    {table = "world_motels", column = "userIdentifier"},
    {table = "world_keys", column = "owner"},
    {table = "notes", column = "charid"},
