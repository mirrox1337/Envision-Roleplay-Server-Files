Locales['sv'] = {
  ...
  ['deposit_society_money']  = 'Sätt in pengar i företaget',
  ...
  ['fire']                   = 'sparka',
  ['grade']                  = 'grade',
  ['have_deposited']         = 'du har satt in %s SEK',
  ...
  ['withdraw_society_money'] = 'Ta ut pengar från företaget',
  ['yes']                    = 'ja',
  ['you_have']               = 'du har %s SEK som väntar på pengartvätt (24h).',
  ['you_have_laundered']     = 'du har tvättat dina pengar: %s SEK',
  ['you_have_hired']         = 'du har anställt %s',
  ['you_have_been_hired']    = 'du har blivit anställd utav %s',
  ['you_have_fired']         = 'du har sparkat %s',
