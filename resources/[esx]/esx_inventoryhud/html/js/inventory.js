...
function inventorySetup(items) {
    ...
    $.each(items, function (index, item) {
        ...
        $("#playerInventory").append('<div class="slot"><div id="item-' + index + '" class="item" style="width: 115px; height: 115px; left: 250px; background-image: url(\'img/items/' + item.name + '.png\')">' +
...
function secondInventorySetup(items) {
    ...
    $.each(items, function (index, item) {
        ...
        $("#otherInventory").append('<div class="slot"><div id="itemOther-' + index + '" class="item" style = "width: 90px; height: 90px; left: 100px; background-image: url(\'img/items/' + item.name + '.png\')">' +
            '<div class="item-count">' + count + '</div> <div class="item-name">' + item.label + '</div> </div ><div class="item-name-bg"></div></div>');
