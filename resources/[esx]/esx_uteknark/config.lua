Config = {
    ...
    Items = { -- What items are used?
        Seed = 'seed_weed',     -- Used to plant the weed
        Tend = 'saffron',             -- Optional item to progress growth cycle
    ...
    YieldSeed = {0,0}, -- Same as Yield, except for the amount of seeds you get back
