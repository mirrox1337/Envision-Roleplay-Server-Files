...
local Markers = {
    ['OpenWitnessMenu'] = { ['x'] = 473.19, ['y'] = -984.63, ['z'] = 25.16 },
    ['SpawnWitness'] = { ['x'] = 468.42, ['y'] = -984.84, ['z'] = 24.30, ['h'] = 267.07 }
}
            ...
            for place, val in pairs(Markers) do
                ...
                if distance < 4.5 then
                    ...
                    if place == 'OpenWitnessMenu' then
                        DrawM('[E] Vittnesmål', 27, val.x, val.y, val.z - 0.945, 255, 255, 255, 0.7, 0.7)
                    end
