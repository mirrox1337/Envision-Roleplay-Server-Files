...
RegisterNetEvent('handsup:getSurrenderStatusPlayer')
AddEventHandler('handsup:getSurrenderStatusPlayer',function(event,source)
		if handsup then
			TriggerServerEvent("handsup:reSendSurrenderStatus",event,source,true)
		else
			TriggerServerEvent("handsup:reSendSurrenderStatus",event,source,false)
		end
end)
