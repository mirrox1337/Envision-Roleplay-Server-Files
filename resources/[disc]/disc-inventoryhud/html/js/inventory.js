...
function inventorySetup(invOwner, items, money, invTier) {
    ...
    $('#cash').html('<img src="img/cash.png" class="moneyIcon"> SEK ' + formatCurrency(money.cash));
    $('#bank').html('<img src="img/bank.png" class="moneyIcon"> SEK ' + formatCurrency(money.bank));
    $('#black_money').html('<img src="img/black_money.png" class="moneyIcon"> SEK ' + formatCurrency(money.black_money));
...
function secondInventorySetup(invOwner, items, invTier, money) {
    ...
    $('#second-cash').html('<img src="img/cash.png" class="moneyIcon"> SEK ' + formatCurrency(money.cash));
    $('#second-black_money').html('<img src="img/black_money.png" class="moneyIcon"> SEK ' + formatCurrency(money.black_money));
    secondUsed = 0;
    $.each(items, function (index, item) {
...
$(document).ready(function () {
    ...
    $("#take").mouseenter(function () {
        ...
        $('.near-players-wrapper').find('.popup-body').html('');
        $('.near-players-wrapper').find('.popup-body').html('');
        $('.near-players-list .popup-body').append(`<div class="cashtake" data-id="cash">Kontanter</div>`);
        $('.near-players-list .popup-body').append(`<div class="cashtake" data-id="black_money">Svarta Pengar</div>`);
        $('.near-players-wrapper').fadeIn();
        EndDragging();
    });
    ...
    $("#store").mouseenter(function () {
        ...
        $('.near-players-wrapper').find('.popup-body').html('');
        $('.near-players-wrapper').find('.popup-body').html('');
        $('.near-players-list .popup-body').append(`<div class="cashstore" data-id="cash">Kontanter</div>`);
        $('.near-players-list .popup-body').append(`<div class="cashstore" data-id="black_money">Svarta Pengar</div>`);
        $('.near-players-wrapper').fadeIn();
        EndDragging();
    });
    ...
    $("#pay").mouseenter(function () {
        ...
        successAudio.play();
        $('.near-players-wrapper').find('.popup-body').html('');
        $('.near-players-list .popup-body').append(`<div class="cashchoice" data-id="cash">Kontanter</div>`);
        $('.near-players-list .popup-body').append(`<div class="cashchoice" data-id="black_money">Svarta Pengar</div>`);
        $('.near-players-wrapper').fadeIn();
        EndDragging();
    });
...
function AddItemToSlot(slot, data) {
    ...
    if (data.price !== undefined && data.price !== 0) {
        slot.find('.item-price').html('SEK ' + data.price);
    }
