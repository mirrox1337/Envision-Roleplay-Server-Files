...
RegisterServerEvent("qalle_motels:globalEvent")
AddEventHandler("qalle_motels:globalEvent", function(options)
    TriggerClientEvent("qalle_motels:eventHandler", -1, options["event"] or "none", options["data"] or nil)
end)

ESX.RegisterServerCallback("qalle_motels:fetchMotels", function(source, callback)
    ...
    if player then
        ...
        MySQL.Async.fetchAll(sqlQuery, {
            ...
            callback(cachedData["motels"], cachedData["storages"], cachedData["furnishings"], playerKeys)
        end)
    else
        callback(false)
    end
...
ESX.RegisterServerCallback("qalle_motels:addItemToStorage", function(source, callback, newTable, newItem, storageId)
    local player = ESX.GetPlayerFromId(source)
    ...
    if player then
        ...
        TriggerClientEvent("qalle_motels:eventHandler", -1, "update_storages", {
            ["newTable"] = newTable,
            ["storageId"] = storageId
        })
...
ESX.RegisterServerCallback("qalle_motels:takeItemFromStorage", function(source, callback, newTable, newItem, storageId)
    local player = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback("qalle_motels:retreivePlayers", function(source, callback, playersSent)
	local player = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback("qalle_motels:buyMotel", function(source, callback, room)
	local player = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback("qalle_motels:getPlayerDressing", function(source, cb)
    local player = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback("qalle_motels:getPlayerOutfit", function(source, cb, num)
    local player = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback("qalle_motels:saveFurnishing", function(source, callback, motelId, furnishingData, ownedFurnishingData)
    local player = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback("qalle_motels:checkMoney", function(source, callback)
    local player = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback("qalle_motels:sellMotel", function(source, callback, motelData)
    local player = ESX.GetPlayerFromId(source)
    ...
    Async.parallel(removeSqlTasks, function(responses)
        if #responses == 4 then
            ...
            player.addMoney(math.ceil(Config.MotelPrice / 500))
...
ESX.RegisterServerCallback("qalle_motels:purchaseFurnishing", function(source, callback, furnishingData, motelId)
    local player = ESX.GetPlayerFromId(source)
    ...
    MySQL.Async.execute(sqlQuery, {
        ...
        if rowsChanged > 0 then
            TriggerClientEvent("qalle_motels:eventHandler", -1, "update_owned_furnishing", {
                ["id"] = motelId,
