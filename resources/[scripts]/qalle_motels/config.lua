...
Config.KeyPrice = 800 -- this is the price for each key that you want to buy.
...
Config.MotelInterior = {
    ["exit"] = vector3(153.33562683105, -1007.9842041016, -99.00),
    ["wardrobe"] = vector3(148.74401855469, -1001.3390283203, -99.00),
    ["invite"] = vector3(154.558375, -1007.8204248047, -99.00)
}
...
Config.LandLord = {
    ["position"] = vector3(313.04959228516, -225.8760760498, 54.201176147461)
}
...
Config.MotelsEntrances = { -- every motel entrance, add more if you want another one.
    ...
    [7] = vector3(313.52093505859, -198.16625976563, 54.221775054932),
    [8] = vector3(315.78137207031, -194.87210083008, 54.226440429688),
    [9] = vector3(319.16732788086, -196.6743927002, 54.226455688477),
    [10] = vector3(321.14105224609, -197.32002258301, 54.226455688477),
    [6] = vector3(311.38592529297, -203.59060668945, 54.221775054932),
...
Config.HelpTextMessage = "~INPUT_CELLPHONE_LEFT~ ~INPUT_CELLPHONE_UP~ ~INPUT_CELLPHONE_DOWN~ ~INPUT_CELLPHONE_RIGHT~ Flytta ~n~"
Config.HelpTextMessage = Config.HelpTextMessage .. "~INPUT_VEH_FLY_ATTACK_CAMERA~ / ~INPUT_CELLPHONE_OPTION~ Höjd ~n~"
Config.HelpTextMessage = Config.HelpTextMessage .. "~INPUT_COVER~ / ~INPUT_CONTEXT~ Rotera ~n~"
Config.HelpTextMessage = Config.HelpTextMessage .. "~INPUT_DETONATE~ Marken ~n~"
Config.HelpTextMessage = Config.HelpTextMessage .. "~INPUT_ENTER~ Byt Föremål ~n~"
Config.HelpTextMessage = Config.HelpTextMessage .. "~INPUT_FRONTEND_ENDSCREEN_ACCEPT~ Placera ~n~"
Config.HelpTextMessage = Config.HelpTextMessage .. "~INPUT_VEH_DUCK~ Avbryt ~n~"
