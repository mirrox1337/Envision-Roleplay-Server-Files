...
local cooldown = 18000 -- amount of time to do the heist again in seconds (30min)
            ...
            if copcount >= mincops then
                if method == 1 then
                    ...
                    if item >= 1 then
                        ...
                        cb("Du har inga Termisk laddning.")
                    end
                elseif method == 2 then
                    ...
                    if item >= 1 then
                        ...
                        cb("Du har inga lockpicks.")
                    end
                end
            else
                cb("Det måste vara minst "..mincops.." poliser i tjänst.")
            end
        else
            cb(math.floor((cooldown - (os.time() - lastrobbed)) / 60)..":"..math.fmod((cooldown - (os.time() - lastrobbed)), 60).." kvar tills banken går att råna igen.")
        end
    else
