TokoVoipConfig = {
	...
	keySwitchChannelsSecondary = Keys["LEFTALT"], -- If set, both the keySwitchChannels and keySwitchChannelsSecondary keybinds must be pressed to switch the radio channels
	keyProximity = Keys["LEFTSHIFT+H"], -- Keybind used to switch the proximity mode
	...
	plugin_data = {
		...
		TSChannel = "I Staden",
		TSPassword = "nutella1", -- TeamSpeak channel password (can be empty)
		...
		TSChannelWait = "När du ska ingame sitter du här",

		-- Blocking screen informations
		TSServer = "Envision.voice.vg", -- TeamSpeak server address to be displayed on blocking screen
		TSChannelSupport = "Support", -- TeamSpeak support channel name displayed on blocking screen
		TSDownload = "Envision discord", -- Download link displayed on blocking screen
