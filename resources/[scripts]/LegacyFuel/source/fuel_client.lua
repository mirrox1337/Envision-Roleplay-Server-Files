...
function ManageFuelUsage(vehicle)
	if not DecorExistOn(vehicle, Config.FuelDecor) then
		SetVehicleFuelLevel(vehicle, math.random(500, 800) / 10.0)
...
AddEventHandler('fuel:refuelFromPump', function(pumpObject, ped, vehicle)
	...
	while isFueling do
		...
		if pumpObject then
			...
			if Config.UseESX then
				extraString = "\nKostnad: ~g~SEK" .. Round(currentCost, 1)
			end
...
if Config.EnableHUD then
	...
	Citizen.CreateThread(function()
		while true do
			...
			if displayHud then
				DrawAdvancedText(0.165 - x, 0.953 - y, 0.005, 0.0028, 0.6, mph, 255, 255, 255, 255, 6, 1)
				--DrawAdvancedText(0.174 - x, 0.77 - y, 0.005, 0.0028, 0.6, kmh, 255, 255, 255, 255, 6, 1)
				DrawAdvancedText(0.210 - x, 0.953 - y, 0.003, 0.0028, 0.6, fuel, 255, 255, 255, 255, 6, 1)
				DrawAdvancedText(0.180 - x, 0.963 - y, 0.006, 0.0028, 0.4, " km/h            % Bränsle", 255, 255, 255, 255, 6, 1)
			else
				Citizen.Wait(750)
			end
		end
