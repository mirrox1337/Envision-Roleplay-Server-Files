...
Config.ItemNeeded = "laptop" -- put any item here for item to hack.
Config.MaxLives = 1 -- this is the max lives in hacking thing 5 is max.
Config.CopsNeeded = 0 -- this is how many cops it needs to be. haha
...
Config.Trolley = {
    ["cash"] = { 400, 800 }, -- this is what you receive every cash stack math.random(1, 2)
