Config = {
    ...
    Locales = {
        ...
        ["drinks"] = "Dricka",
        ["snacks"] = "Snacks",
        ["readymeal"] = "Färdiga mål",
        ["diverse"] = "Diverse",
    },

    Items = {
        ["drinks"] = {
            {label = "Coca Cola", item = "cocacola", price = 21},
            {label = "Fanta Exotic", item = "fanta", price = 21},
            {label = "Sprite", item = "sprite", price = 21},
            {label = "Loka Crush", item = "loka", price = 21},
        },
        ["snacks"] = {
            {label = "OLW Ostbågar", item = "cheesebows", price = 25},
            {label = "OLW 3xLök Chips", item = "chips", price = 25},
            {label = "Marabou Mjölkchoklad", item = "marabou", price = 27},
        },
        ["readymeal"] = {
            {label = "Kebab Pizza", item = "pizza", price = 35},
            {label = "Bacon Burgare", item = "burger", price = 50},
            {label = "Pasta Carbonara", item = "pastacarbonara", price = 30},
            {label = "Skinkmacka", item = "macka", price = 25},
        },
        ["diverse"] = {
            {label = "Cigarett", item = "cigarett", price = 10},
            {label = "Tändare", item = "lighter", price = 30},
            {label = "Trisslott", item = "scratchoff", price = 150},
            {label = "Telefon", item = "phone", price = 450},
            {label = "Näringsberikat vatten", item = "saffron", price = 16},
            {label = "Lithium Batteri", item = "lithium", price = 800},
            {label = "Kikare", item = "jumelles", price = 500},
            {label = "Vaskpanna", item = "pan", price = 400},
            {label = "Bajspåse", item = "blackplasticbag", price = 10},
