...
Config.VehicleMenuButton = 182 -- change this to the key you want to open the menu with. buttons: https://docs.fivem.net/game-references/controls/
...
Config.Labels = {
    ...
    ["vehicle"] = "~INPUT_CONTEXT~ Parkera '%s' i ditt garage."
}
