...
RegisterServerEvent('esx_policejob:getOfficeKey')
AddEventHandler('esx_policejob:getOfficeKey', function()
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
	local getKeyQuantity = xPlayer.getInventoryItem('policeoffice').count

	if getKeyQuantity >= 1 then
		TriggerClientEvent('esx:showNotification', _source, 'Du har redan ett nyckelkort.')
	else
	  xPlayer.addInventoryItem('policeoffice', 1)		
		TriggerClientEvent('esx:showNotification', _source, 'Du tog ut ett nyckelkort.')
	end
end)

RegisterServerEvent('esx_policejob:putOfficeKey')
AddEventHandler('esx_policejob:putOfficeKey', function()
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
	local removeKeyQuantity = xPlayer.getInventoryItem('policeoffice').count
	
	if removeKeyQuantity >= 1 then
		xPlayer.removeInventoryItem('policeoffice', 1)
		TriggerClientEvent('esx:showNotification', _source, 'Du lämnade in ditt nyckelkort.')
	else
		TriggerClientEvent('esx:showNotification', _source, 'Du har inget nyckelkort.')
	end
...
RegisterServerEvent('esx_policejob:getRadio')
AddEventHandler('esx_policejob:getRadio', function()
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
	local getRadioQuantity = xPlayer.getInventoryItem('radio').count

	if getRadioQuantity >= 1 then
		--TriggerClientEvent('esx:showNotification', _source, 'Du har redan en radio.')
	else
	  xPlayer.addInventoryItem('radio', 1)		
		--TriggerClientEvent('esx:showNotification', _source, 'Du tog ut en radio.')
	end
end)

RegisterServerEvent('esx_policejob:putRadio')
AddEventHandler('esx_policejob:putRadio', function()
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
	local getRadioQuantity = xPlayer.getInventoryItem('radio').count
	...
	if getRadioQuantity >= 1 then
		...
		--TriggerClientEvent('esx:showNotification', _source, 'Du lämnade in din radio.')
	else
		--TriggerClientEvent('esx:showNotification', _source, 'Du har ingen radio att lämna in.')
	end
end)