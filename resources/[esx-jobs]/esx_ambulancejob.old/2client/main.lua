...
--vector3(327.29769897461, -595.79187011719, 28.791481018066)--boss
--vector3(338.67562866211, -585.19683837891, 28.791481018066)--inout
RegisterNetEvent('esx_ambulancejob:multicharacter')
AddEventHandler('esx_ambulancejob:multicharacter', function()
    IsDead = false
    exports.spawnmanager:setAutoSpawn(true) -- disable respawn
    FirstSpawn = false
