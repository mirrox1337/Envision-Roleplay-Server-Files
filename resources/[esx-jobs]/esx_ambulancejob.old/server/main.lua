...
RegisterServerEvent('medic:carying')
AddEventHandler('medic:carying', function(target)
	local targetPlayer = ESX.GetPlayerFromId(target)
	print(target)
	TriggerClientEvent('medic:lifting', targetPlayer.source, source)
end)
...
ESX.RegisterUsableItem('medikit', function(source)
    ...
    TriggerClientEvent("mythic_hospital:items:medkit", _source)
    TriggerClientEvent('mythic_hospital:client:RemoveBleed', _source)
    TriggerClientEvent('mythic_hospital:client:UsePainKiller', _source, 2)
...
ESX.RegisterUsableItem('firstaid', function(source)
    ...
    TriggerClientEvent("mythic_hospital:items:firstaid", _source)
    TriggerClientEvent('mythic_hospital:client:RemoveBleed', _source)
    TriggerClientEvent('mythic_hospital:client:ResetLimbs', _source)
	--TriggerClientEvent('esx_ambulancejob:heal', _source, 'big')
	--TriggerClientEvent('esx:showNotification', _source, _U('used_medikit'))
end)
...
ESX.RegisterUsableItem('bandage', function(source)
    ...
    TriggerClientEvent("mythic_hospital:items:bandage", _source)
    TriggerClientEvent('mythic_hospital:client:ReduceBleed', _source)
...
ESX.RegisterUsableItem('vicodin', function(source)
    ...
    TriggerClientEvent("mythic_hospital:items:vicodin", _source, 'vicodin')
	--TriggerClientEvent('esx_ambulancejob:heal', _source, 'big')
	--TriggerClientEvent('esx:showNotification', _source, _U('used_medikit'))
end)
...
ESX.RegisterUsableItem('hydrocodone', function(source)
    ...
    TriggerClientEvent("mythic_hospital:items:hydrocodone", _source, 'hydrocodone')
	--TriggerClientEvent('esx_ambulancejob:heal', _source, 'big')
	--TriggerClientEvent('esx:showNotification', _source, _U('used_medikit'))
end)
...
ESX.RegisterUsableItem('morphine', function(source)
    ...
    TriggerClientEvent("mythic_hospital:items:morphine", _source, 'morphine')
	--TriggerClientEvent('esx_ambulancejob:heal', _source, 'big')
	--TriggerClientEvent('esx:showNotification', _source, _U('used_medikit'))
end)
