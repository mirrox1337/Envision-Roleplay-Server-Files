...
INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('Securitas',0,'recruit','vakt',250,'{}','{}'),
	('Securitas',1,'officer','Biträdande veteran vakt',300,'{}','{}'),
	('Securitas',2,'sergeant','Assistent',350,'{}','{}'),
	('Securitas',3,'lieutenant','vice chef',500,'{}','{}'),
	('Securitas',4,'boss','chef',850junibackenjobsjobsjobs,'{}','{}')
;

CREATE TABLE `fine_types_Securitas` (
...
INSERT INTO `fine_types_Securitas` (label, amount, category) VALUES
