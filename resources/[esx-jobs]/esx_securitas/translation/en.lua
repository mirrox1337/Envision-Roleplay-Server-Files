Locales['en'] = {
  ...
  ['securitas_wear'] = 'securitas Outfit',
  ...
  ['being_searched'] = 'you are being ~y~searched~s~ by the ~b~Securitas~s~',
  -- Vehicle interaction
