...
Config.Zones = {
  ...
  Cloakroom = {
	...
	BlipSprite = 384,
	BlipColor = 1,
	BlipName = Config.nameJobLabel.." : locker room",
	hint = 'Tryck ~INPUT_CONTEXT~ för att komma åt omklädningsrummet',
  },
  ...
  VehicleSpawner = {
	...
	hint = 'Tryck ~INPUT_CONTEXT~ för att komma åt garaget',
  },
  ...
  VehicleDeleter = {
	...
	hint = 'Tryck ~INPUT_CONTEXT~ för att ställa in jobb bilen',
  },
  ...
  Vente = {
	...
	ItemRequires_name = "Kvitton",
	ItemDrop = 100,
	ItemPrice  = 55,
	hint = 'Tryck ~INPUT_CONTEXT~ för att lämna in kvitton',
  },
