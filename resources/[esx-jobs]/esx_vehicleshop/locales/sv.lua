Locales['sv'] = {
  ...
  ['player_cannot_hold']      = 'du har inte tillräckligt mycketplats på dig!',
  ...
  ['shop_menu']               = '~INPUT_CONTEXT~ Öppna företagsmenyn',
  ['generic_shopitem']        = '%s SEK',
  ['vehicle_dealer']          = 'bilförsäljare - fordon för visning',
  ['vehicle_menu']            = '~INPUT_CONTEXT~ Lämna tillbaka fordon',
